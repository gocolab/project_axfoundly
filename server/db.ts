...
const SEED_MEMBERS: AdminMember[] = [
  ...
  { id: "m-mahau", name: "마하우", email: "mahau.master@gmail.com", roles: ["admin", "member"], joinDate: "2025-02-01", lastLogin: "2025-08-20", status: "활성", courseCount: 1 },
  ...
  { id: "m8", name: "박탈퇴", email: "withdrawn.user@mail.com", roles: ["member"], joinDate: "2024-05-12", lastLogin: "2025-06-01", status: "탈퇴", courseCount: 0, withdrawalReason: "운영 정책 위반(반복적 광고성 게시글 등록)으로 인한 관리자 직권 강제 탈퇴", withdrawnAt: "2025-06-02T10:30:00Z" },
  { id: "m9", name: "가상멤버", email: "virtual.ai@platform.com", roles: ["member"], joinDate: "2025-08-01", lastLogin: "2025-08-20", status: "가상활성", courseCount: 0 },
];
